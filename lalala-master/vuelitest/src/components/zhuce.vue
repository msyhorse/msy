<template><div class="zhuce"><NavTop class="Navtop"></NavTop><div class="d1"><p class="d3">注册新账号</p><hr width="90%" class="d4"><div class="d2"><el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
